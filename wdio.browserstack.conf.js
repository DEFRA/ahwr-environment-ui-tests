...
export const config = {
  ...
  baseUrl: `https://ahwr-environment-ui-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `ahwr-environment-ui-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `ahwr-environment-ui-tests-${process.env.ENVIRONMENT}`
        },
